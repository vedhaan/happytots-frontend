    ...
    <div className="why-htps">
      ...
      <p>Glimpses of joyful learning at Happy Tots</p>
          ...
          <div className="gallery-grid">
            ...
            <div className="gallery-item">
              <img src={`${images[1]}`} alt="Art Class" />
              <div className="gallery-overlay">
            ...
            <div className="gallery-item">
              <img src={`${images[2]}`} alt="Story Time" />
              <div className="gallery-overlay">
                <h4>Story Time</h4>
            ...
            <div className="gallery-item">
              <img src={`${images[3]}`} alt="Science Fun" />
              <div className="gallery-overlay">
            ...
            <div className="gallery-item">
              <img src={`${images[4]}`} alt="Music Class" />
              <div className="gallery-overlay">
            ...
            <div className="gallery-item">
              <img src={`${images[5]}`} alt="Group Activity" />
              <div className="gallery-overlay">
                <h4>Team Building</h4>
